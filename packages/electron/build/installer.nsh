...
!macro customInit
  ...
  ${If} ${RunningX64}
    ...
    ; NOTE:
    ; ここで既にVisual C++がinstallされてるかどうかをチェックしている
    ...
    IfErrors 0 VSRedistInstalled
    ReadRegStr $R0 HKCR "Installer\Dependencies\VC,redist.x64,amd64,14.30,bundle" "Version"
    IfErrors 0 VSRedistInstalled
  ...
  ${Else}
    ...
    IfErrors 0 VSRedistInstalled
    ReadRegStr $R0 HKCR "Installer\Dependencies\VC,redist.x86,x86,14.26,bundle" "Version"
    IfErrors 0 VSRedistInstalled
    ReadRegStr $R0 HKCR "Installer\Dependencies\VC,redist.x86,x86,14.27,bundle" "Version"
    IfErrors 0 VSRedistInstalled
    ReadRegStr $R0 HKCR "Installer\Dependencies\VC,redist.x86,x86,14.28,bundle" "Version"
    IfErrors 0 VSRedistInstalled
    ReadRegStr $R0 HKCR "Installer\Dependencies\VC,redist.x86,x86,14.29,bundle" "Version"
    IfErrors 0 VSRedistInstalled
    ReadRegStr $R0 HKCR "Installer\Dependencies\VC,redist.x86,x86,14.30,bundle" "Version"
    IfErrors 0 VSRedistInstalled
