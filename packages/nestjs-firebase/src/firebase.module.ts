...
export class FirebaseModule {
  ...
  public static forRootAsync(options: FirebaseModuleAsyncOptions): DynamicModule {
  ...
  private static createAsyncOptionsProvider(options: FirebaseModuleAsyncOptions): Provider {
    ...
    return {
      provide: FirebaseConstants.FIREBASE_MODULE,
      useFactory: async (optionsFactory: FirebaseModuleOptionsFactory): Promise<FirebaseModuleOptions> =>
